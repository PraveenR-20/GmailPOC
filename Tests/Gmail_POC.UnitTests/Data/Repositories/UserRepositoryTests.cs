...
namespace Gmail_POC.UnitTests.Data.Repositories
{
    public class UserRepositoryTests
    {
        ...
        [Fact]
        public async Task UserList_SuccessTest()
        {
            userRepositoryMock.Setup(p => p.GetUsers()).Returns(Task.FromResult(PreapareUsersList()));
        ...
        private IEnumerable<Users> PreapareUsersList()
        {
            return new List<Users>() {
                 new Users(){  ClientId = "test", SecretKey = "test", Email ="test@test.com" , FirstName="test",LastName = "test", Id = 1
                 }
